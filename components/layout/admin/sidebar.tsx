    ...
    return (
        <div className={cn('flex h-full lg:w-[256px] w-[256px] ' +
            ...
            <div className='flex flex-col gap-y-2 flex-1'>
                ...
                <SidebarItem label='Modules' href='/dashboard/modules' iconSrc='/common/leaderboard.svg' />
                <SidebarItem label='Courses' href='/quests' iconSrc='/common/quests.svg' />
                <SidebarItem label='Users' href='/shop' iconSrc='/common/shop.svg' />
