...
export const HowItWorksBanner = () => {
    return (
        <>
            <section className="w-full bg-indigo-50 dark:bg-[hsl(210,15%,15%)] py-12">
                <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl sm:text-4xl font-bold text-center text-sky-800 dark:text-sky-300 mb-10">
                        EzDu কীভাবে কাজ করে?
                    </h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div
                            ...
                            <ul className="list-disc list-inside space-y-4 text-slate-600 dark:text-slate-300 text-sm">
